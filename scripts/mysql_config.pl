...
my $ldata   = '/Users/xh/workspaces/learning/mysql-5.5.62/build_out/data';
my $execdir = '/Users/xh/workspaces/learning/mysql-5.5.62/build_out/bin';
my $bindir  = '/Users/xh/workspaces/learning/mysql-5.5.62/build_out/bin';

# ----------------------------------------------------------------------
# If installed, search for the compiled in directory first (might be "lib64")
# ----------------------------------------------------------------------

my $pkglibdir = fix_path('/Users/xh/workspaces/learning/mysql-5.5.62/build_out/lib',"libmysql/relwithdebinfo",
                         "libmysql/release","libmysql/debug","lib/mysql","lib");

my $pkgincludedir = fix_path('/Users/xh/workspaces/learning/mysql-5.5.62/build_out/include', "include/mysql", "include");
